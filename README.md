...
export const metadata = {
  title: 'Hoteb.ai',
  description:
    'Hoteb.ai: Your AI language companion. Powered by OpenAI, it enhances your conversations, content creation, and more!',
};
```
    ...
    <div className='hero min-h-screen bg-base-200'>
      <div className='hero-content text-center'>
        <div className='max-w-md'>
          <h1 className='text-6xl font-bold text-primary'>Hoteb.ai</h1>
          <p className='py-6 text-lg leading-loose'>
            Hoteb.ai: Your AI language companion. Powered by OpenAI, it
...
const SidebarHeader = () => {
  return (
    <div className='flex items-center mb-4 gap-4 px-4'>
      ...
      <h2 className='text-xl font-extrabold text-primary mr-auto'>Hoteb.ai</h2>
      <ThemeToggle />
    </div>
  );
};
  ...
  return (
    <>
      <form onSubmit={handleSubmit} className='max-w-2xl'>
        <h2 className=' mb-4'>Click the button to start recording</h2>
        <div className='join w-full'>
          <input
            type='text'
            className='input input-bordered join-item w-full'
...
const NewTour = () => {
  ...
  return (
    <>
      <form onSubmit={handleSubmit} className='max-w-2xl'>
        <h2 className=' mb-4'>Click the button to start recordingn</h2>
        <div className='join w-full'>
          <input
            type='text'
            className='input input-bordered join-item w-full'
          ...
          <button
            ...
            disabled={isPending}
          >
            {isPending ? 'please wait...' : 'generate report'}
          </button>
        </div>
      </form>
      <div className='mt-16'>
